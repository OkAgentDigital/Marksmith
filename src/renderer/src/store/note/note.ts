...
export class NoteStore extends StructStore<typeof state> {
  ...
  // Workspace Settings Popover methods
  toggleWorkspaceSettings = () => {
    this.setState((state) => ({
      workspaceSettingsVisible: !state.workspaceSettingsVisible
    }))
  }

  openWorkspaceSettings = () => {
    this.setState({ workspaceSettingsVisible: true })
  }

  closeWorkspaceSettings = () => {
    this.setState({ workspaceSettingsVisible: false })
  }
}

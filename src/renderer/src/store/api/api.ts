...
export class ModelApi {
  ...
  async getDocumentPath(docId: string, workspaceName: string): Promise<string> {
    return ipcRenderer.invoke('getDocumentPath', docId, workspaceName)
  }

  async readDocumentContent(docId: string, workspaceName: string): Promise<string> {
    return ipcRenderer.invoke('readDocumentContent', docId, workspaceName)
  }
}

...
import { WorkspaceSettingsPopover } from './ui/settings/WorkspaceSettingsPopover'
    ...
    >
      <StoreContext value={store}>
        ...
        <WorkspaceSettingsPopover
          visible={store.note.state.workspaceSettingsVisible}
          onClose={() => store.note.closeWorkspaceSettings()}
        />
      </StoreContext>
    </ThemeProvider>
  )
